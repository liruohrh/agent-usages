 ...
 *
 * Rates are per 1,000,000 tokens, transcribed from DeepSeek's official *Models &
 * Pricing* pages — the Chinese one in yuan, the English one in dollars — plus
 * archived snapshots for periods no longer published. Nothing here is
 * interpolated: every period was announced by DeepSeek, and each carries the URL
 * it came from.
 *
...
/** The price list DeepSeek publishes for the Chinese site. */
const CNY: PricingCurrency = { code: 'CNY', symbol: '¥' };

/** The price list DeepSeek publishes for the international site. */
const USD: PricingCurrency = { code: 'USD', symbol: '$' };
...
/** The same page in English, which is the one that quotes dollars. */
const DOCS_PRICING_EN = 'https://api-docs.deepseek.com/quick_start/pricing';
const ARCHIVE_EN = (stamp: string): string =>
  `https://web.archive.org/web/${stamp}/https://api-docs.deepseek.com/quick_start/pricing/`;
...
/**
 * The English site's price history.
 *
 * DeepSeek publishes its list twice — yuan for the Chinese site, dollars for the
 * international one — and the two are separate published numbers, not a
 * conversion of each other (the dollar prices are the yuan ones rounded to two
 * or three significant digits, which is not the same thing). Both are kept, so a
 * report shows the list the reader's currency actually belongs to.
 *
 * Windows, peak rules and labels mirror the yuan list; only the numbers and the
 * source differ. Sources (fetched 2026-09-21): the English *Models & Pricing*
 * page and its archived snapshots at the dates each yuan period changed.
 */
const FLASH_PERIODS_USD: readonly PricePeriod[] = [
  {
    id: '2026-01-01',
    label: 'V3.2（deepseek-chat / deepseek-reasoner）统一价',
    from: beijing('2026-01-01T00:00:00'),
    to: beijing('2026-04-24T00:00:00'),
    offPeak: flat('0.028', '0.28', '0.42'),
    peak: null,
    peakWindows: [],
    timezone: 'Asia/Shanghai',
    currency: USD,
    source: ARCHIVE_EN('20260323134549'),
    note: 'V3.2 统一价（美元表）。',
  },
  {
    id: '2026-04-24',
    ...
    from: beijing('2026-04-24T00:00:00'),
    to: beijing('2026-04-26T20:15:00'),
    offPeak: flat('0.028', '0.14', '0.28'),
    peak: null,
    peakWindows: [],
    timezone: 'Asia/Shanghai',
    currency: USD,
    source: ARCHIVE_EN('20260424030643'),
    note: '预览版上线价（美元表）。',
  },
  {
    id: '2026-04-26',
    ...
    from: beijing('2026-04-26T20:15:00'),
    to: beijing('2026-08-17T00:00:00'),
    offPeak: flat('0.0028', '0.14', '0.28'),
    peak: null,
    peakWindows: [],
    timezone: 'Asia/Shanghai',
    currency: USD,
    source: ARCHIVE_EN('20260607093431'),
    note: '缓存命中价降至 1/10（美元表）。',
  },
  {
    id: '2026-08-17',
    label: 'V4-Flash（正式版）峰谷定价',
    from: beijing('2026-08-17T00:00:00'),
    to: beijing('2026-08-23T00:00:00'),
    offPeak: flat('0.007', '0.22', '0.66'),
    peak: flat('0.014', '0.44', '1.32'),
    peakWindows: PEAK_WINDOWS_EVERY_DAY,
    timezone: 'Asia/Shanghai',
    currency: USD,
    source: ARCHIVE_EN('20260816161307'),
    note: '首次启用峰谷定价（美元表）；此阶段高峰时段未限定工作日。',
  },
  {
    id: '2026-08-23',
    label: 'V4-Flash（正式版）峰谷定价（周末全天低谷）',
    ...
    timezone: 'Asia/Shanghai',
    currency: USD,
    source: ARCHIVE_EN('20260822130627'),
    note: '周末全天低谷（美元表）；单价不变。',
  },
  {
    id: '2026-09-10',
    label: 'V4.1-Flash（deepseek-flash）峰谷定价',
    from: beijing('2026-09-10T12:00:00'),
    to: null,
    offPeak: flat('0.003', '0.15', '0.6'),
    peak: flat('0.006', '0.3', '1.2'),
    peakWindows: PEAK_WINDOWS_WEEKDAYS,
    timezone: 'Asia/Shanghai',
    currency: USD,
    source: DOCS_PRICING_EN,
    note: 'V4.1-Flash 上线并同步降价（美元表）。',
  },
];

const PRO_PERIODS_USD: readonly PricePeriod[] = [
  {
    id: '2026-04-24',
    label: 'V4-Pro 预览版上线价',
    from: beijing('2026-04-24T00:00:00'),
    to: beijing('2026-04-26T20:15:00'),
    offPeak: flat('0.145', '1.74', '3.48'),
    peak: null,
    peakWindows: [],
    timezone: 'Asia/Shanghai',
    currency: USD,
    source: ARCHIVE_EN('20260424030643'),
    note: 'V4-Pro 预览版上线价（美元表，list price）。',
  },
  {
    id: '2026-04-26',
    label: 'V4-Pro 限时 2.5 折',
    from: beijing('2026-04-26T20:15:00'),
    to: beijing('2026-06-01T00:00:00'),
    offPeak: flat('0.003625', '0.435', '0.87'),
    peak: null,
    peakWindows: [],
    timezone: 'Asia/Shanghai',
    currency: USD,
  ...
  },
  {
    ...
    from: beijing('2026-08-17T00:00:00'),
    to: beijing('2026-08-23T00:00:00'),
    offPeak: flat('0.022', '0.66', '1.98'),
    peak: flat('0.044', '1.32', '3.96'),
    peakWindows: PEAK_WINDOWS_EVERY_DAY,
    timezone: 'Asia/Shanghai',
    currency: USD,
    source: ARCHIVE_EN('20260816161307'),
    note: '峰谷定价（美元表）；此阶段高峰时段未限定工作日。',
  },
  {
    id: '2026-08-23',
    label: 'V4-Pro（正式版）峰谷定价（周末全天低谷）',
...
export const DEEPSEEK_PRICES: readonly ModelPrice[] = [
  {
    ...
    periods: [...FLASH_PERIODS, ...FLASH_PERIODS_USD],
  },
  {
    model: 'deepseek-v4-pro',
    aliases: ['deepseek-v4-pro'],
    periods: [...PRO_PERIODS, ...PRO_PERIODS_USD],
  },
];
